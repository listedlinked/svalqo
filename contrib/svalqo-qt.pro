...
RESOURCES += src/qt/svalqo.qrc src/qt/svalqo_locale.qrc

TRANSLATIONS += src/qt/locale/svalqo_bg.ts \
                src/qt/locale/svalqo_de.ts \
                src/qt/locale/svalqo_en.ts \
                src/qt/locale/svalqo_es.ts \
                src/qt/locale/svalqo_fi.ts \
                src/qt/locale/svalqo_fr.ts \
                src/qt/locale/svalqo_it.ts \
                src/qt/locale/svalqo_ja.ts \
                src/qt/locale/svalqo_pl.ts \
                src/qt/locale/svalqo_pt.ts \
                src/qt/locale/svalqo_ru.ts \
                src/qt/locale/svalqo_sk.ts \
                src/qt/locale/svalqo_sv.ts \
                src/qt/locale/svalqo_vi.ts \
                src/qt/locale/svalqo_zh_CN.ts \
                src/qt/locale/svalqo_zh_TW.ts
