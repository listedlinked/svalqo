...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SVALQO Core svalqo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  svalqo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded svalqo transaction") + "\n" +
                               "  svalqo-tx [options] -create [commands]   " + _("Create hex-encoded svalqo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded svalqo transaction
