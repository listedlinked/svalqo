...
/** Utility functions used by the SVALQO Qt UI.
 */
namespace GUIUtil
{
...
// Render SVALQO addresses in monospace font
...
// Parse "svalqo:" URI into recipient object, return true on successful parsing
