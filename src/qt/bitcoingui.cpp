                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SVALQO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SVALQO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and svalqo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SVALQO Core"), this);
    aboutAction->setStatusTip(tr("Show information about SVALQO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SVALQO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SVALQO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SVALQO addresses"));
    ...
    openAction->setStatusTip(tr("Open a SVALQO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SVALQO Core help message to get a list with possible SVALQO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SVALQO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SVALQO network", "", count));
}
...
{
    QString strTitle = tr("SVALQO Core"); // default title
