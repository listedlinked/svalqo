...
In order to support loading of multiple wallets in svalqo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is svalqo.cpp.
...
Changes to svalqo.cpp
----------------------
svalqo.cpp is the entry point into svalqo-qt, and as such, will require some minor modifications to provide hooks for
