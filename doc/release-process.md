...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/listedlinked/svalqo/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/listedlinked/svalqo-DETACHED.SIGS.git
...
### Build and sign SVALQO Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit svalqo=v${VERSION} ../svalqo/contrib/gitian-descriptors/gitian-win.yml
